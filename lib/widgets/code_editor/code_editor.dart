...
import 'package:flutter_interactive_graph/widgets/code_editor/custom_highlight_with_overlay.dart';
...
class _CodeEditorState extends State<CodeEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    //         return Container(
    //           width: 55,
    //           margin: const EdgeInsets.only(right: 15), // == padding right above
    //           child: TextButton(
  ...
  Mode? getModeFromLanguage() {
    if (widget.model.getFileWithIndex(0).language == 'python') {
      return python;
    } else if (widget.model.getFileWithIndex(0).language == 'json') {
      return json;
    }
  }
}
